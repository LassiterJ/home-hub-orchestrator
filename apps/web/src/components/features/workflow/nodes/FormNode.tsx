...
import { FileText, Info, LucideIcon } from 'lucide-react'
import { BaseNode, BaseNodeContent, BaseNodeFooter, BaseNodeHeader, BaseNodeHeaderTitle } from './BaseNode'
import { GroupNode } from '@/components/features/workflow/nodes/GroupNode'
import { memo } from 'react'
import { NodeStatus } from '@/components/features/workflow/NodeStatusIndicator'

/**
 * Notes:
 * I think the form node support an "edit" mode which changes the view to have the window panes and the form display
 * node changes to this group node containing individual input nodes.
 *
 *
 * */
export const FormGroupNode = memo((props) => <GroupNode {...props} />)
