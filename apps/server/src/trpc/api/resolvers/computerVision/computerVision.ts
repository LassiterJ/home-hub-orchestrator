// server/src/trpc/api/resolvers/computerVision/computerVision.ts
...
const getDetectionsProc = publicProcedure
    .input(z.instanceof(FormData)) // <— THIS makes `opts.input` a Uint8Array
    .mutation(async (opts) => {
        console.log("***computerVision.ts***");
...
export const computerVisionRouter = router({
   detect: getDetectionsProc
})
